...
BOT_TOKEN = environ['BOT_TOKEN','5440002317:AAFmyWTiXTtjh-deeaFw4q-gTzWFn7TD9Cs']
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5958870787').split()]
